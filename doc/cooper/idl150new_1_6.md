...
This describes the Z-Wave device *ID-150*, manufactured by *ID Lock AS* with the thing type UID of ```ID Lock AS_idl150new_01_006```.
This version of the device is limited to firmware versions above 1.6

The device is in the category of *Lock*, defining Devices whose primary pupose is locking something.

![ID-150 product image](https://opensmarthouse.org/assets/zwave/attachments/1106/front-silver-2x.png)
...
| Alarm (emergency)  [Deprecated]| alarm_emergency | alarm_emergency |  |  | 
| Alarm (burglar) | alarm_burglar | alarm_burglar |  |  | 
| Alarm (raw)  [Deprecated]| alarm_raw | alarm_raw |  |  | 
