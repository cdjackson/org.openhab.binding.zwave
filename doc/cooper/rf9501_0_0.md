...
This describes the Z-Wave device *RF9501*, manufactured by *Cooper Wiring Devices* with the thing type UID of ```Cooper Wiring Devices_rf9501_00_000```.

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![RF9501 product image](https://opensmarthouse.org/assets/zwave/attachments/18/RF9501.jpg)
