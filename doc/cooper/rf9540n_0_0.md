...
This describes the Z-Wave device *RF9540-N*, manufactured by *Cooper Wiring Devices* with the thing type UID of ```Cooper Wiring Devices_rf9540n_00_000```.

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![RF9540-N product image](https://opensmarthouse.org/assets/zwave/attachments/16/RF9540-NDW-l-220.jpg)
