...
![LZW31-SN product image](https://opensmarthouse.org/assets/zwave/attachments/1146/Switch-Mockup-Download-570x570.jpg)
...
| LED Strip Effect | config_decimal | config_decimal |  |  | 
| Default Level (Local) | config_decimal | config_decimal |  |  | 
| LED Indicator Color | config_decimal | config_decimal |  |  | 
| LED Indicator Intensity | config_decimal | config_decimal |  |  | 
| Protection Local | protection_local | protection_local |  |  | 
