...
This describes the Z-Wave device *TZDW-100*, manufactured by *[Telldus Technologies AB](http://www.telldus.com/)* with the thing type UID of ```Telldus Technologies AB_tzdw100_00_000```.

The device is in the category of *Sensor*, defining Device used to measure something.

![TZDW-100 product image](https://opensmarthouse.org/assets/zwave/attachments/312/TZDW-100.png)
