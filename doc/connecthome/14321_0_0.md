...
This describes the Z-Wave device *GE/Jasco 14321*, manufactured by *Jasco Products* with the thing type UID of ```Jasco Products_14321_00_000```.

The device is in the category of *HVAC*, defining Air condition devices, Fans.

![GE/Jasco 14321 product image](https://opensmarthouse.org/assets/zwave/attachments/583/14287-1-2.png)
