...
This describes the Z-Wave device *FGDW002*, manufactured by *[Fibargroup](http://www.fibaro.com/)* with the thing type UID of ```Fibargroup_fgdw002_00_000```.

The device is in the category of *Sensor*, defining Device used to measure something.

![FGDW002 product image](https://opensmarthouse.org/assets/zwave/attachments/604/FGDW002.jpg)
