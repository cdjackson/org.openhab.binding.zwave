...
![014G0210 product image](https://opensmarthouse.org/assets/zwave/attachments/935/danfoss-hc10-hydronic-contoller-10-outputs.jpg)
...
| Indicator 1 | indicator_flash1 | indicator_flash |  |  | 
| Thermostat mode 2 | thermostat_mode2 | thermostat_mode |  |  | 
| Setpoint (heating) 2 | thermostat_setpoint2 | thermostat_setpoint |  |  | 
| Alarm 2 | alarm_general2 | alarm_general |  |  | 
| Thermostat mode 3 | thermostat_mode3 | thermostat_mode |  |  | 
| Setpoint (heating) 3 | thermostat_setpoint3 | thermostat_setpoint |  |  | 
| Alarm 3 | alarm_general3 | alarm_general |  |  | 
| Thermostat mode 4 | thermostat_mode4 | thermostat_mode |  |  | 
| Setpoint (heating) 4 | thermostat_setpoint4 | thermostat_setpoint |  |  | 
| Alarm 4 | alarm_general4 | alarm_general |  |  | 
| Thermostat mode 5 | thermostat_mode5 | thermostat_mode |  |  | 
| Setpoint (heating) 5 | thermostat_setpoint5 | thermostat_setpoint |  |  | 
| Alarm 5 | alarm_general5 | alarm_general |  |  | 
| Thermostat mode 6 | thermostat_mode6 | thermostat_mode |  |  | 
| Setpoint (heating) 6 | thermostat_setpoint6 | thermostat_setpoint |  |  | 
| Alarm 6 | alarm_general6 | alarm_general |  |  | 
| Thermostat mode 7 | thermostat_mode7 | thermostat_mode |  |  | 
| Setpoint (heating) 7 | thermostat_setpoint7 | thermostat_setpoint |  |  | 
| Alarm 7 | alarm_general7 | alarm_general |  |  | 
| Thermostat mode 8 | thermostat_mode8 | thermostat_mode |  |  | 
| Setpoint (heating) 8 | thermostat_setpoint8 | thermostat_setpoint |  |  | 
| Alarm 8 | alarm_general8 | alarm_general |  |  | 
| Thermostat mode 9 | thermostat_mode9 | thermostat_mode |  |  | 
| Setpoint (heating) 9 | thermostat_setpoint9 | thermostat_setpoint |  |  | 
| Alarm 9 | alarm_general9 | alarm_general |  |  | 
| Thermostat mode 10 | thermostat_mode10 | thermostat_mode |  |  | 
| Setpoint (heating) 10 | thermostat_setpoint10 | thermostat_setpoint |  |  | 
| Alarm 10 | alarm_general10 | alarm_general |  |  | 
| Switch 11 | switch_binary11 | switch_binary |  |  | 
| Switch 12 | switch_binary12 | switch_binary |  |  | 
