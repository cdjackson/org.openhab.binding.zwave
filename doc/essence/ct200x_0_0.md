...
This describes the Z-Wave device *CT200X*, manufactured by *Radio Thermostat Company of America (RTC)* with the thing type UID of ```Radio Thermostat Company of America (RTC)_ct200x_00_000```.

The device is in the category of *HVAC*, defining Air condition devices, Fans.

![CT200X product image](https://opensmarthouse.org/assets/zwave/attachments/938/CT200.jpeg)
