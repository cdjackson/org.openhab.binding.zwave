...
This describes the Z-Wave device *GE 14295*, manufactured by *Jasco Products* with the thing type UID of ```Jasco Products_14295_00_000```.

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![GE 14295 product image](https://opensmarthouse.org/assets/zwave/attachments/680/14295-1.png)
