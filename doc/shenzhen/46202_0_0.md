...
This describes the Z-Wave device *GE 46202*, manufactured by *Jasco Products* with the thing type UID of ```Jasco Products_46202_00_000```.

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![GE 46202 product image](https://opensmarthouse.org/assets/zwave/attachments/1109/GE46202.png)
