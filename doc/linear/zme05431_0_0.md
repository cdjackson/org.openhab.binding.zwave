...
# ZME_05431 Switch
This describes the Z-Wave device *ZME_05431*, manufactured by *Reitz-Group.de* with the thing type UID of ```Reitz-Group.de_zme05431_00_000```.

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![ZME_05431 product image](https://opensmarthouse.org/assets/zwave/attachments/566/05431.png)
