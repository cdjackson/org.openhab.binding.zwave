...
This describes the Z-Wave device *WT00Z-1*, manufactured by *Linear Corp* with the thing type UID of ```Linear Corp_wt00z1_00_000```.

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![WT00Z-1 product image](https://opensmarthouse.org/assets/zwave/attachments/13/WT00Z1.jpg)
