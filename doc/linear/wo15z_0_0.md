...
This describes the Z-Wave device *WO15Z*, manufactured by *Linear Corp* with the thing type UID of ```Linear Corp_wo15z_00_000```.

The device is in the category of *Power Outlet*, defining Small devices to be plugged into a power socket in a wall which stick there.

![WO15Z product image](https://opensmarthouse.org/assets/zwave/attachments/12/WO15Z-1.jpg)
