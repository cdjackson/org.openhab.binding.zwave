...
This describes the Z-Wave device *11-01-011*, manufactured by *Sensative AB* with the thing type UID of ```Sensative AB_1101011_00_000```.

The device is in the category of *Sensor*, defining Device used to measure something.

![11-01-011 product image](https://opensmarthouse.org/assets/zwave/attachments/251/sensative-strips.jpg)
