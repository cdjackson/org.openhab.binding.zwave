...
# ZW111 Nano Dimmer
This describes the Z-Wave device *ZW111*, manufactured by *[AEON Labs](http://aeotec.com/)* with the thing type UID of ```AEON Labs_zw111_00_000```.
This version of the device is limited to firmware versions below 2.2

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![ZW111 product image](https://opensmarthouse.org/assets/zwave/attachments/576/ZW111-boxed.jpeg)
