...
This describes the Z-Wave device *ZW4101*, manufactured by *[Vision Security](http://www.visionsecurity.com.tw/)* with the thing type UID of ```Vision Security_zw4101_00_000```.

The device is in the category of *Blinds*, defining Roller shutters, window blinds, etc..

![ZW4101 product image](https://opensmarthouse.org/assets/zwave/attachments/300/zw4101.png)
