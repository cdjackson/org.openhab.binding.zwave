...
This describes the Z-Wave device *ID-150*, manufactured by *ID Lock AS* with the thing type UID of ```ID Lock AS_idl150_00_000```.
This version of the device is limited to firmware versions below 1.5

The device is in the category of *Lock*, defining Devices whose primary pupose is locking something.

![ID-150 product image](https://opensmarthouse.org/assets/zwave/attachments/887/front-silver-2x.png)
