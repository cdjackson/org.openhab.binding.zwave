...
This describes the Z-Wave device *FT116*, manufactured by *[Fantem](http://www.oomi.com/)* with the thing type UID of ```Fantem_ft116_00_000```.

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![FT116 product image](https://opensmarthouse.org/assets/zwave/attachments/890/FT116-C.jpg)
