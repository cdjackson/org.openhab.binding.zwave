...
This describes the Z-Wave device *StellaZ*, manufactured by *Eurotronics* with the thing type UID of ```Eurotronics_stellaz_00_000```.

The device is in the category of *Radiator Control*, defining Controls on radiators used to heat up rooms.

![StellaZ product image](https://opensmarthouse.org/assets/zwave/attachments/183/stellaz.jpg)
