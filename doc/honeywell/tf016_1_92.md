...
![TF016 product image](https://opensmarthouse.org/assets/zwave/attachments/896/thermofloor.png)
...
| Power setting value | config_decimal | config_decimal |  |  | 
| Relay state | switch_binary1 | switch_binary |  |  | 
| Air temperature sensor | sensor_temperature2 | sensor_temperature |  |  | 
| External temperature sensor | sensor_temperature3 | sensor_temperature |  |  | 
| Floor temperature sensor | sensor_temperature4 | sensor_temperature |  |  | 
