...
This describes the Z-Wave device *DMDP1*, manufactured by *Elexa Consumer Products Inc.* with the thing type UID of ```Elexa Consumer Products Inc._dmdp1_00_000```.

The device is in the category of *Sensor*, defining Device used to measure something.

![DMDP1 product image](https://opensmarthouse.org/assets/zwave/attachments/884/DMDP1.jpg)
