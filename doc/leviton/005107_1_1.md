...
This describes the Z-Wave device *005107*, manufactured by *Popp & Co* with the thing type UID of ```Popp & Co_005107_01_001```.
This version of the device is limited to firmware version 1.1

The device is in the category of *Siren*, defining Siren used by Alarm systems.

![005107 product image](https://opensmarthouse.org/assets/zwave/attachments/367/popp5107.jpg)
