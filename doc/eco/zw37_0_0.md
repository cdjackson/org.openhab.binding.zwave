...
This describes the Z-Wave device *ZW37*, manufactured by *NIE Technology* with the thing type UID of ```NIE Technology_zw37_00_000```.

The device is in the category of *Power Outlet*, defining Small devices to be plugged into a power socket in a wall which stick there.

![ZW37 product image](https://opensmarthouse.org/assets/zwave/attachments/745/NZW37.jpg)
