...
This describes the Z-Wave device *FGCD001*, manufactured by *[Fibargroup](http://www.fibaro.com/)* with the thing type UID of ```Fibargroup_fgcd001_00_000```.

The device is in the category of *Sensor*, defining Device used to measure something.

![FGCD001 product image](https://opensmarthouse.org/assets/zwave/attachments/711/co-zwave.png)
...
| Carbon Monoxide Sensor | sensor_co | sensor_co |  |  | 
...
| Sensor Alarm (general) | alarm_general | alarm_general |  |  | 
