...
This describes the Z-Wave device *ZW3011/14296*, manufactured by *Jasco Products* with the thing type UID of ```Jasco Products_14296_00_000```.

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![ZW3011/14296 product image](https://opensmarthouse.org/assets/zwave/attachments/1270/14296-ep-01.jpg)
