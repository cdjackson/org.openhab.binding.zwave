...
This describes the Z-Wave device *FF-ZWAVE5-ECO*, manufactured by *Ecolink* with the thing type UID of ```Ecolink_firefighter5_00_000```.

The device is in the category of *Smoke Detector*, defining Smoke detectors.

![FF-ZWAVE5-ECO product image](https://opensmarthouse.org/assets/zwave/attachments/1221/FF-ZWAVE5-ECO.jpg)
...
| Temperature | sensor_temperature | sensor_temperature |  |  | 
