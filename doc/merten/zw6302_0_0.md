...
This describes the Z-Wave device *ZW6302*, manufactured by *Jasco Products* with the thing type UID of ```Jasco Products_zw6302_00_000```.

The device is in the category of *Motion Detector*, defining Motion sensors/detectors.

![ZW6302 product image](https://opensmarthouse.org/assets/zwave/attachments/447/zw6302.png)
