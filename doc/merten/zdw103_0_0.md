...
This describes the Z-Wave device *ZDW103*, manufactured by *ACT - Advanced Control Technologies* with the thing type UID of ```ACT - Advanced Control Technologies_zdw103_00_000```.

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![ZDW103 product image](https://opensmarthouse.org/assets/zwave/attachments/463/zdw103.jpg)
