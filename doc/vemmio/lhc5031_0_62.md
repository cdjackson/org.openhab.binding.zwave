...
This describes the Z-Wave device *LHC5031*, manufactured by *[Logic Group](http://www.logic-group.com)* with the thing type UID of ```Logic Group_lhc5031_00_062```.
This version of the device is limited to firmware versions above 0.62

The device is in the category of *HVAC*, defining Air condition devices, Fans.

![LHC5031 product image](https://opensmarthouse.org/assets/zwave/attachments/673/Heatit-Z-Water.png)
...
| Input (temperature) 1 | sensor_temperature11 | sensor_temperature |  |  | 
| Input (temperature) 2 | sensor_temperature12 | sensor_temperature |  |  | 
| Input (temperature) 3 | sensor_temperature13 | sensor_temperature |  |  | 
| Input (temperature) 4 | sensor_temperature14 | sensor_temperature |  |  | 
