...
This describes the Z-Wave device *28177*, manufactured by *Jasco Products* with the thing type UID of ```Jasco Products_28177_00_000```.

The device is in the category of *Power Outlet*, defining Small devices to be plugged into a power socket in a wall which stick there.

![28177 product image](https://opensmarthouse.org/assets/zwave/attachments/761/28177.png)
