...
This describes the Z-Wave device *ZW3107 / GE 14280*, manufactured by *Jasco Products* with the thing type UID of ```Jasco Products_14280_00_000```.

The device is in the category of *Power Outlet*, defining Small devices to be plugged into a power socket in a wall which stick there.

![ZW3107 / GE 14280 product image](https://opensmarthouse.org/assets/zwave/attachments/719/14280.png)
