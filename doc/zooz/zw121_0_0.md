...
This describes the Z-Wave device *ZW121*, manufactured by *[AEON Labs](http://aeotec.com/)* with the thing type UID of ```AEON Labs_zw121_00_000```.

The device is in the category of *Light Bulb*, defining Devices that illuminate something, such as bulbs, etc..

![ZW121 product image](https://opensmarthouse.org/assets/zwave/attachments/639/zw121-1.jpg)
...
| Configuration Parameter 37 | meter_current | meter_current |  |  | 
