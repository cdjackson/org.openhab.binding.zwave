...
This describes the Z-Wave device *PD03Z*, manufactured by *[Shenzhen Neo Electronics Co., Ltd](http://www.szneo.com/)* with the thing type UID of ```Shenzhen Neo Electronics Co., Ltd_pd03z_00_000```.

The device is in the category of *Motion Detector*, defining Motion sensors/detectors.

![PD03Z product image](https://opensmarthouse.org/assets/zwave/attachments/973/pd03z.jpg)
