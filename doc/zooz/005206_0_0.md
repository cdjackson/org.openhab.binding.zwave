...
# 005206 Z-Weather
This describes the Z-Wave device *005206*, manufactured by *Popp & Co* with the thing type UID of ```Popp & Co_005206_00_000```.

The device is in the category of *Sensor*, defining Device used to measure something.

![005206 product image](https://opensmarthouse.org/assets/zwave/attachments/512/Z-Weather.png)
