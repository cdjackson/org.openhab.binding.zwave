...
This describes the Z-Wave device *HS-WS200+*, manufactured by *[HomeSeer Technologies](http://www.homeseer.com/)* with the thing type UID of ```HomeSeer Technologies_hsws200_05_012```.
This version of the device is limited to firmware versions above 5.12

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![HS-WS200+ product image](https://opensmarthouse.org/assets/zwave/attachments/1168/ws200.png)
...
| Status LED Color | config_decimal | config_decimal |  |  | 
| Switch LED Blink Frequency | config_decimal | config_decimal |  |  | 
| Scene Control | config_decimal | config_decimal |  |  | 
