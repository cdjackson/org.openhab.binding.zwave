...
This describes the Z-Wave device *FGWDSEU*, manufactured by *[Fibargroup](http://www.fibaro.com/)* with the thing type UID of ```Fibargroup_fgwdseu_00_000```.

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![FGWDSEU product image](https://opensmarthouse.org/assets/zwave/attachments/1181/FGWDSEU-221.jpg)
...
| Switch Binary | switch_binary1 | switch_binary |  |  | 
| Electric meter (watts) | meter_watts1 | meter_watts |  |  | 
| Electric meter (kWh) | meter_kwh1 | meter_kwh |  |  | 
| Switch Binary | switch_binary2 | switch_binary |  |  | 
| Electric meter (watts) | meter_watts2 | meter_watts |  |  | 
| Electric meter (kWh) | meter_kwh2 | meter_kwh |  |  | 
