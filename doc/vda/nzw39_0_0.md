...
# NZW39 Dimming Plug
This describes the Z-Wave device *NZW39*, manufactured by *Willis Electric Co., Ltd.* with the thing type UID of ```Willis Electric Co., Ltd._nzw39_00_000```.

The device is in the category of *Power Outlet*, defining Small devices to be plugged into a power socket in a wall which stick there.

![NZW39 product image](https://opensmarthouse.org/assets/zwave/attachments/770/willis-nzw39.png)
