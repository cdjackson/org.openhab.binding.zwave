...
|--------------|------------|--------------|----------|-----------|
| Smoke Alarm Sensor | alarm_smoke | alarm_smoke |  |  | 
| Relative Humidity Sensor | sensor_relhumidity | sensor_relhumidity |  |  | 
| Luminance Sensor | sensor_luminance | sensor_luminance |  |  | 
| Temperature Sensor | sensor_temperature | sensor_temperature |  |  | 
| Carbon Dioxide (CO2) Sensor | sensor_co2 | sensor_co2 |  |  | 
| Volatile Organic Compound (VOC) Sensor | sensor_voc | sensor_voc |  |  | 
| Loudness Sensor | sensor_loudness | sensor_loudness |  |  | 
| Particulate Matter (PM2.5) Sensor | sensor_particulate | sensor_particulate |  |  | 
| PIR Motion Sensor | alarm_motion | alarm_motion |  |  | 
