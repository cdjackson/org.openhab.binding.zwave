...
![XLED Home 2 product image](https://opensmarthouse.org/assets/zwave/attachments/688/Steinel-XLED.png)
...
| Control: Key01 lamp (on/off) | switch_binary1 | switch_binary |  |  | 
| Scene Number 1 | scene_number1 | scene_number |  |  | 
| Alarm (burglar) motion | alarm_burglar2 | alarm_burglar |  |  | 
| Sensor (luminance)2 | sensor_luminance3 | sensor_luminance |  |  | 
