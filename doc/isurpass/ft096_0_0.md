...
This describes the Z-Wave device *FT096*, manufactured by *[Fantem](http://www.oomi.com/)* with the thing type UID of ```Fantem_ft096_00_000```.

The device is in the category of *Power Outlet*, defining Small devices to be plugged into a power socket in a wall which stick there.

![FT096 product image](https://opensmarthouse.org/assets/zwave/attachments/730/ft096.jpeg)
