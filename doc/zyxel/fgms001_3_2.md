...
This describes the Z-Wave device *FGMS001*, manufactured by *[Fibargroup](http://www.fibaro.com/)* with the thing type UID of ```Fibargroup_fgms001_03_002```.
This version of the device is limited to firmware versions above 3.2

The device is in the category of *Motion Detector*, defining Motion sensors/detectors.

![FGMS001 product image](https://opensmarthouse.org/assets/zwave/attachments/328/fgms001.jpg)
...
| Sensor (seismic intensity) | sensor_seismicintensity | sensor_seismicintensity |  |  | 
