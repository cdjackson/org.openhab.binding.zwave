...
This describes the Z-Wave device *PA-100*, manufactured by *Dragon Tech Industrial, Ltd.* with the thing type UID of ```Dragon Tech Industrial, Ltd._pa100_00_000```.

The device is in the category of *Power Outlet*, defining Small devices to be plugged into a power socket in a wall which stick there.

![PA-100 product image](https://opensmarthouse.org/assets/zwave/attachments/241/PA-100.png)
