...
This describes the Z-Wave device *ZW187*, manufactured by *Aeotec Limited* with the thing type UID of ```Aeotec Limited_zw187_00_000```.

The device is in the category of *Sensor*, defining Device used to measure something.

![ZW187 product image](https://opensmarthouse.org/assets/zwave/attachments/1226/E-Where-to-buy-image-2x.png)
