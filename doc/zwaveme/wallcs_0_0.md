...
This describes the Z-Wave device *WALLC-S*, manufactured by *Z-Wave.Me* with the thing type UID of ```Z-Wave.Me_wallcs_00_000```.

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![WALLC-S product image](https://opensmarthouse.org/assets/zwave/attachments/145/z-waveme-z-waveme-wall-controller-without-frame-and-paddles-zme-wallc-2.jpg)
