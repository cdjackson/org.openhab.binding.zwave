...
This describes the Z-Wave device *05433*, manufactured by *Reitz-Group.de* with the thing type UID of ```Reitz-Group.de_05433_00_000```.

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![05433 product image](https://opensmarthouse.org/assets/zwave/attachments/51/-05433.png)
