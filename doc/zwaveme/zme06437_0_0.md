...
This describes the Z-Wave device *ZME_06437*, manufactured by *Z-Wave.Me* with the thing type UID of ```Z-Wave.Me_zme06437_00_000```.

The device is in the category of *Power Outlet*, defining Small devices to be plugged into a power socket in a wall which stick there.

![ZME_06437 product image](https://opensmarthouse.org/assets/zwave/attachments/142/POPE009105.jpg)
