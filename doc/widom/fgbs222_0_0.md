...
|--------------|------------|--------------|----------|-----------|
| Sensor (temperature) Internal | sensor_temperature | sensor_temperature |  |  | 
| Scene Number | scene_number | scene_number |  |  | 
| Input 1 Alarm | alarm_burglar1 | alarm_burglar |  |  | 
| Input 2 Alarm | alarm_burglar2 | alarm_burglar |  |  | 
| Input 1 Voltage | meter_voltage3 | meter_voltage |  |  | 
| Input 2 Voltage | meter_voltage4 | meter_voltage |  |  | 
| Switch Output 1 | switch_binary5 | switch_binary |  |  | 
| Protection Local Output 1 | protection_local5 | protection_local |  |  | 
| Protection RF Output 1 | protection_rf5 | protection_rf |  |  | 
| Switch Output 2 | switch_binary6 | switch_binary |  |  | 
| Protection Local Output 2 | protection_local6 | protection_local |  |  | 
| Protection RF Output 2 | protection_rf6 | protection_rf |  |  | 
| Sensor (temperature) Device Overheat | alarm_heat7 | alarm_heat |  |  | 
| Sensor (temperature) 1 | sensor_temperature8 | sensor_temperature |  |  | 
| Sensor (temperature) 1 Device Error | notification_system8 | notification_system |  |  | 
| Relative Humidity 1 | sensor_relhumidity9 | sensor_relhumidity |  |  | 
| Sensor (temperature) 2 | sensor_temperature9 | sensor_temperature |  |  | 
| Sensor (temperature) 2 Device Error | notification_system9 | notification_system |  |  | 
| Sensor (temperature) 3 | sensor_temperature10 | sensor_temperature |  |  | 
| Sensor (temperature) 3 Device Error | notification_system10 | notification_system |  |  | 
| Sensor (temperature) 4 | sensor_temperature11 | sensor_temperature |  |  | 
| Sensor (temperature) 4 Device Error | notification_system11 | notification_system |  |  | 
| Sensor (temperature) 5 | sensor_temperature12 | sensor_temperature |  |  | 
| Sensor (temperature) 5 Device Error | notification_system12 | notification_system |  |  | 
| Sensor (temperature) 6 | sensor_temperature13 | sensor_temperature |  |  | 
| Sensor (temperature) 6 Device Error | notification_system13 | notification_system |  |  | 
