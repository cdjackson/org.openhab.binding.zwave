...
This describes the Z-Wave device *MH10-PM2.5-WA*, manufactured by *[McoHome Technology Co., Ltd](http://www.mcohome.com/)* with the thing type UID of ```McoHome Technology Co., Ltd_mh10pm25wa_00_000```.

The device is in the category of *Sensor*, defining Device used to measure something.

![MH10-PM2.5-WA product image](https://opensmarthouse.org/assets/zwave/attachments/244/MH10-PM2-5-WA.png)
...
| Sensor (particulate) | sensor_particulate | sensor_particulate |  |  | 
