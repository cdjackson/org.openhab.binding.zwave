...
This describes the Z-Wave device *WD-100*, manufactured by *Dragon Tech Industrial, Ltd.* with the thing type UID of ```Dragon Tech Industrial, Ltd._wd100_00_000```.

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![WD-100 product image](https://opensmarthouse.org/assets/zwave/attachments/243/WD-100.jpg)
