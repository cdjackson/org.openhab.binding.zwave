...
This describes the Z-Wave device *ZW141*, manufactured by *[AEON Labs](http://aeotec.com/)* with the thing type UID of ```AEON Labs_zw141_00_000```.

The device is in the category of *Blinds*, defining Roller shutters, window blinds, etc..

![ZW141 product image](https://opensmarthouse.org/assets/zwave/attachments/912/z-wave-nano-shutter.png)
