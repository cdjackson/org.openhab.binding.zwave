...
This describes the Z-Wave device *10002041-130*, manufactured by *SimonTech S.L.U* with the thing type UID of ```SimonTech S.L.U_10002041130_00_000```.

The device is in the category of *Power Outlet*, defining Small devices to be plugged into a power socket in a wall which stick there.

![10002041-130 product image](https://opensmarthouse.org/assets/zwave/attachments/999/Index-jpeg.png)
