...
This describes the Z-Wave device *HSM02*, manufactured by *[Chromagic Technologies Corporation](http://www.ctc-chromagic.com/)* with the thing type UID of ```Chromagic Technologies Corporation_hsm02_00_000```.

The device is in the category of *Sensor*, defining Device used to measure something.

![HSM02 product image](https://opensmarthouse.org/assets/zwave/attachments/342/HSM02.png)
