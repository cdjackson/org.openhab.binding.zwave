...
This describes the Z-Wave device *ZW122*, manufactured by *[AEON Labs](http://aeotec.com/)* with the thing type UID of ```AEON Labs_zw122_00_000```.

The device is in the category of *Sensor*, defining Device used to measure something.

![ZW122 product image](https://opensmarthouse.org/assets/zwave/attachments/721/zw122.jpeg)
...
| Alarm (flood) 1 | alarm_flood1 | alarm_flood |  |  | 
| Alarm (flood) 2 | alarm_flood2 | alarm_flood |  |  | 
