...
This describes the Z-Wave device *ZMNHUD*, manufactured by *[Goap](http://www.qubino.com/)* with the thing type UID of ```Goap_zmnhud_00_000```.

The device is in the category of *HVAC*, defining Air condition devices, Fans.

![ZMNHUD product image](https://opensmarthouse.org/assets/zwave/attachments/715/zmnhud.png)
