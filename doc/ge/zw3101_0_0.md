...
# ZW3101 Lamp Module
This describes the Z-Wave device *ZW3101*, manufactured by *Jasco Products* with the thing type UID of ```Jasco Products_zw3101_00_000```.

The device is in the category of *Power Outlet*, defining Small devices to be plugged into a power socket in a wall which stick there.

![ZW3101 product image](https://opensmarthouse.org/assets/zwave/attachments/44/ZW3101.jpg)
