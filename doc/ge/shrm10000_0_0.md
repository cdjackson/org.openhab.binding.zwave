...
This describes the Z-Wave device *SHRM10000*, manufactured by *ABUS Security-Center GmbH & Co. KG * with the thing type UID of ```ABUS Security-Center GmbH & Co. KG _shrm10000_00_000```.

The device is in the category of *Smoke Detector*, defining Smoke detectors.

![SHRM10000 product image](https://opensmarthouse.org/assets/zwave/attachments/1047/abus.jpeg)
