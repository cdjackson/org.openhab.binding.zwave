...
This describes the Z-Wave device *SES 302*, manufactured by *Horstmann Controls Limited* with the thing type UID of ```Horstmann Controls Limited_ses302_00_000```.

The device is in the category of *Sensor*, defining Device used to measure something.

![SES 302 product image](https://opensmarthouse.org/assets/zwave/attachments/505/ses302.jpg)
