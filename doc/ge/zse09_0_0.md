...
![ZSE09 product image](https://opensmarthouse.org/assets/zwave/attachments/584/zse09-zooz-z-wave-mini-sensor-original-front.jpg)
...
|--------------|------------|--------------|----------|-----------|
| sensor_binary | sensor_binary | sensor_binary |  |  | 
| alarm_motion | alarm_motion | alarm_motion |  |  | 
| sensor_luminance | sensor_luminance | sensor_luminance |  |  | 
