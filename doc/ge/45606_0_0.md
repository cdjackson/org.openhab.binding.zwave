...
This describes the Z-Wave device *45606, ZW3003*, manufactured by *Jasco Products* with the thing type UID of ```Jasco Products_45606_00_000```.

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![45606, ZW3003 product image](https://opensmarthouse.org/assets/zwave/attachments/41/45606.png)
