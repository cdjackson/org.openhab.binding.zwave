...
This describes the Z-Wave device *DMMS1*, manufactured by *Elexa Consumer Products Inc.* with the thing type UID of ```Elexa Consumer Products Inc._dmms1_00_000```.

The device is in the category of *Motion Detector*, defining Motion sensors/detectors.

![DMMS1 product image](https://opensmarthouse.org/assets/zwave/attachments/797/Dome-DMMS1-006.jpg)
