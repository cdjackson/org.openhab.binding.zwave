...
This describes the Z-Wave device *Kwikset SmartCode 910*, manufactured by *[Black & Decker](http://www.kwikset.com/)* with the thing type UID of ```Black & Decker_910_00_000```.

The device is in the category of *Lock*, defining Devices whose primary pupose is locking something.

![Kwikset SmartCode 910 product image](https://opensmarthouse.org/assets/zwave/attachments/1025/smartcode910.jpg)
