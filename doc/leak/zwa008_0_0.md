...
This describes the Z-Wave device *ZWA008*, manufactured by *Aeotec Limited* with the thing type UID of ```Aeotec Limited_zwa008_00_000```.

The device is in the category of *Sensor*, defining Device used to measure something.

![ZWA008 product image](https://opensmarthouse.org/assets/zwave/attachments/1065/ZWA008.PNG)
