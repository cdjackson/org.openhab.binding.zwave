...
This describes the Z-Wave device *06436*, manufactured by *Z-Wave.Me* with the thing type UID of ```Z-Wave.Me_06436_00_000```.

The device is in the category of *Blinds*, defining Roller shutters, window blinds, etc..

![06436 product image](https://opensmarthouse.org/assets/zwave/attachments/50/ZME-06436.jpg)
