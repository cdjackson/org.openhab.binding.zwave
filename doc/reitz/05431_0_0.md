...
This describes the Z-Wave device *Reitz 05431*, manufactured by *Reitz-Group.de* with the thing type UID of ```Reitz-Group.de_05431_00_000```.

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![Reitz 05431 product image](https://opensmarthouse.org/assets/zwave/attachments/55/ZW-ES-1000.png)
