...
This describes the Z-Wave device *ZMNHWD*, manufactured by *[Goap](http://www.qubino.com/)* with the thing type UID of ```Goap_zmnhwd_00_000```.

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![ZMNHWD product image](https://opensmarthouse.org/assets/zwave/attachments/567/qubino-z-wave-flush-rgbw-dimmer-zmnhwd1.jpg)
...
| Scene | config_decimal | config_decimal |  |  | 
| Scene Color Change Duration | config_decimal | config_decimal |  |  | 
| Brightness 1 | switch_dimmer1 | switch_dimmer |  |  | 
| Brightness 2 | switch_dimmer2 | switch_dimmer |  |  | 
| Brightness 3 | switch_dimmer3 | switch_dimmer |  |  | 
| Brightness 4 | switch_dimmer4 | switch_dimmer |  |  | 
