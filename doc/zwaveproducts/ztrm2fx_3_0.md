...
| Energy Saving Mode Setpoint (ECO) | config_decimal | config_decimal |  |  | 
| Heating mode setpoint (Comfort) | config_decimal | config_decimal |  |  | 
| Display brightness - dimmed | config_decimal | config_decimal |  |  | 
| Button brightness - dimmed | config_decimal | config_decimal |  |  | 
| Thermostat mode | thermostat_mode1 | thermostat_mode |  |  | 
| Setpoint (cooling) | thermostat_setpoint1 | thermostat_setpoint |  |  | 
| Setpoint (heating) | thermostat_setpoint1 | thermostat_setpoint |  |  | 
| Setpoint (Furnace) | thermostat_setpoint1 | thermostat_setpoint |  |  | 
| External sensor | sensor_temperature2 | sensor_temperature |  |  | 
| Floor sensor | sensor_temperature3 | sensor_temperature |  |  | 
| Switch binary | switch_binary4 | switch_binary |  |  | 
| Electric meter (volts) 4 | meter_voltage4 | meter_voltage |  |  | 
| Electric meter (kWh) 4 | meter_kwh4 | meter_kwh |  |  | 
| Electric meter (watts) 4 | meter_watts4 | meter_watts |  |  | 
| Resets Device Usage 4  [Deprecated]| meter_reset4 | meter_reset |  |  | 
