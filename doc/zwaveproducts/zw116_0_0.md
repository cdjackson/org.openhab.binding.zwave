...
This describes the Z-Wave device *ZW116*, manufactured by *[AEON Labs](http://aeotec.com/)* with the thing type UID of ```AEON Labs_zw116_00_000```.
This version of the device is limited to firmware versions below 2.0

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![ZW116 product image](https://opensmarthouse.org/assets/zwave/attachments/591/zw116.jpg)
