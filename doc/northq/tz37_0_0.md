...
This describes the Z-Wave device *TZ37*, manufactured by *TKB Home* with the thing type UID of ```TKB Home_tz37_00_000```.

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![TZ37 product image](https://opensmarthouse.org/assets/zwave/attachments/562/TZ37.jpg)
