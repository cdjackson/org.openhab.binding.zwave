...
This describes the Z-Wave device *123610*, manufactured by *Popp & Co* with the thing type UID of ```Popp & Co_123610_00_000```.

The device is in the category of *Power Outlet*, defining Small devices to be plugged into a power socket in a wall which stick there.

![123610 product image](https://opensmarthouse.org/assets/zwave/attachments/231/123610.png)
