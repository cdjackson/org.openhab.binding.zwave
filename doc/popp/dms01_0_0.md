...
| Notification Sound | config_decimal | config_decimal |  |  | 
| Primary Notification Volume | config_decimal | config_decimal |  |  | 
| Secondary Notification Volume | config_decimal | config_decimal |  |  | 
| Primary Notification Sound | config_decimal | config_decimal |  |  | 
| Secondary Notification Sound | config_decimal | config_decimal |  |  | 
| Primary Notification Length | config_decimal | config_decimal |  |  | 
| Secondary Notification Length | config_decimal | config_decimal |  |  | 
