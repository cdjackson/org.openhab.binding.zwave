...
This describes the Z-Wave device *FGT001*, manufactured by *[Fibargroup](http://www.fibaro.com/)* with the thing type UID of ```Fibargroup_fgt001_00_000```.

The device is in the category of *Radiator Control*, defining Controls on radiators used to heat up rooms.

![FGT001 product image](https://opensmarthouse.org/assets/zwave/attachments/749/FGT-001.jpg)
