...
This describes the Z-Wave device *FGS223*, manufactured by *[Fibargroup](http://www.fibaro.com/)* with the thing type UID of ```Fibargroup_fgs223_00_000```.

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![FGS223 product image](https://opensmarthouse.org/assets/zwave/attachments/416/fgs-223.jpg)
...
| Send notification | notification_send | notification_send |  |  | 
| Alarm (power)  [Deprecated]| alarm_power | alarm_power |  |  | 
