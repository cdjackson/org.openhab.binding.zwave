...
This describes the Z-Wave device *05438*, manufactured by *Popp & Co* with the thing type UID of ```Popp & Co_05438_00_000```.

The device is in the category of *Power Outlet*, defining Small devices to be plugged into a power socket in a wall which stick there.

![05438 product image](https://opensmarthouse.org/assets/zwave/attachments/230/plug-switch-300x236.png)
