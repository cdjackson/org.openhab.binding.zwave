...
This describes the Z-Wave device *009303*, manufactured by *Popp & Co* with the thing type UID of ```Popp & Co_009303_00_000```.

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![009303 product image](https://opensmarthouse.org/assets/zwave/attachments/233/009303.png)
