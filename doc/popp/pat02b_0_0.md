...
This describes the Z-Wave device *PAT02-B*, manufactured by *[Philio Technology Corp](http://www.philio-tech.com/)* with the thing type UID of ```Philio Technology Corp_pat02b_00_000```.

The device is in the category of *Sensor*, defining Device used to measure something.

![PAT02-B product image](https://opensmarthouse.org/assets/zwave/attachments/533/pat02-b.jpg)
