...
![Heating Control product image](https://opensmarthouse.org/assets/zwave/attachments/473/BenextHeatingControl.png)
...
|--------------|------------|--------------|----------|-----------|
| Room temperature | room_temperature | sensor_temperature |  |  | 
| Outside temperature | outside_temperature | sensor_temperature |  |  | 
| Thermostat mode | thermostat_mode | thermostat_mode |  |  | 
| Heating setpoint | thermostat_setpoint | thermostat_setpoint |  |  | 
| Energy save setpoint | thermostat_setpoint | thermostat_setpoint |  |  | 
