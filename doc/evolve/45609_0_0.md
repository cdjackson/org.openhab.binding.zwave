...
This describes the Z-Wave device *45609*, manufactured by *Jasco Products* with the thing type UID of ```Jasco Products_45609_00_000```.

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![45609 product image](https://opensmarthouse.org/assets/zwave/attachments/40/jasco45609.jpg)
