...
This describes the Z-Wave device *12729*, manufactured by *Jasco Products* with the thing type UID of ```Jasco Products_12729_00_000```.

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![12729 product image](https://opensmarthouse.org/assets/zwave/attachments/319/white-ge-dimmers-12729-64-1000.jpg)
