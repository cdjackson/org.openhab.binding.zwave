...
This describes the Z-Wave device *NZW96*, manufactured by *NIE Technology* with the thing type UID of ```NIE Technology_nzw96_00_000```.

The device is in the category of *Power Outlet*, defining Small devices to be plugged into a power socket in a wall which stick there.

![NZW96 product image](https://opensmarthouse.org/assets/zwave/attachments/825/inovelli-outdoor.jpg)
