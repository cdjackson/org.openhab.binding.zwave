...
This describes the Z-Wave device *ZW140*, manufactured by *[AEON Labs](http://aeotec.com/)* with the thing type UID of ```AEON Labs_zw140_00_000```.

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![ZW140 product image](https://opensmarthouse.org/assets/zwave/attachments/813/DualNanoSwitch.jpg)
