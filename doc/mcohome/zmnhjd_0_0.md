...
# ZMNHJD Flush Pilot
This describes the Z-Wave device *ZMNHJD*, manufactured by *[Goap](http://www.qubino.com/)* with the thing type UID of ```Goap_zmnhjd_00_000```.

The device is in the category of *Radiator Control*, defining Controls on radiators used to heat up rooms.

![ZMNHJD product image](https://opensmarthouse.org/assets/zwave/attachments/273/Qubino.png)
