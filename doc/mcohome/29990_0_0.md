...
This describes the Z-Wave device *29990*, manufactured by *Systemair Sverige AS* with the thing type UID of ```Systemair Sverige AS_29990_00_000```.

The device is in the category of *HVAC*, defining Air condition devices, Fans.

![29990 product image](https://opensmarthouse.org/assets/zwave/attachments/430/SystemairSverigeAS.jpeg)
...
|--------------|------------|--------------|----------|-----------|
| Boost mode | switch_binary | switch_binary |  |  | 
