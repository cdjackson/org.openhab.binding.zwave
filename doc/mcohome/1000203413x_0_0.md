...
This describes the Z-Wave device *10002080-13x*, manufactured by *SimonTech S.L.U* with the thing type UID of ```SimonTech S.L.U_1000203413x_00_000```.

The device is in the category of *Blinds*, defining Roller shutters, window blinds, etc..

![10002080-13x product image](https://opensmarthouse.org/assets/zwave/attachments/930/tecla-master-persianas-io-10002081-130-simon-100-blanco.jpg)
