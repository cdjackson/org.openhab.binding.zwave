...
This describes the Z-Wave device *MSP-3-1-X1*, manufactured by *[ID-RF](http://www.nodon.fr/)* with the thing type UID of ```ID-RF_msp31x1_00_000```.

The device is in the category of *Power Outlet*, defining Small devices to be plugged into a power socket in a wall which stick there.

![MSP-3-1-X1 product image](https://opensmarthouse.org/assets/zwave/attachments/435/MSP-3-1.png)
