...
This describes the Z-Wave device *HS-WD200+*, manufactured by *[HomeSeer Technologies](http://www.homeseer.com/)* with the thing type UID of ```HomeSeer Technologies_hswd200511_05_011```.
This version of the device is limited to firmware versions above 5.11

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![HS-WD200+ product image](https://opensmarthouse.org/assets/zwave/attachments/1040/hs-wd200.png)
...
| Sets switch mode of operation | config_decimal | config_decimal |  |  | 
| Normal mode LED colour | config_decimal | config_decimal |  |  | 
| Status mode LED 1 Colour | config_decimal | config_decimal |  |  | 
| Sets LED operation (in normal mode) | config_decimal | config_decimal |  |  | 
| Sets paddle’s load orientation  | config_decimal | config_decimal |  |  | 
| Status mode LED 2 Colour | config_decimal | config_decimal |  |  | 
| Status mode LED 3 Colour | config_decimal | config_decimal |  |  | 
| Status mode LED 4 Colour | config_decimal | config_decimal |  |  | 
| Status mode LED 5 Colour | config_decimal | config_decimal |  |  | 
| Status mode LED 6 Colour | config_decimal | config_decimal |  |  | 
| Status mode LED 7 Colour | config_decimal | config_decimal |  |  | 
| Status mode LEDs Blink frequency | config_decimal | config_decimal |  |  | 
