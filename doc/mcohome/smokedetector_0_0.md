...
This describes the Z-Wave device *Smoke Detector*, manufactured by *Shenzhen iSurpass Technology Co. ,Ltd* with the thing type UID of ```Shenzhen iSurpass Technology Co. ,Ltd_smokedetector_00_000```.

The device is in the category of *Smoke Detector*, defining Smoke detectors.

![Smoke Detector product image](https://opensmarthouse.org/assets/zwave/attachments/728/co-sensor-hs1caz.jpg)
