...
This describes the Z-Wave device *MH-S512-IL*, manufactured by *[McoHome Technology Co., Ltd](http://www.mcohome.com/)* with the thing type UID of ```McoHome Technology Co., Ltd_mhs512il_00_000```.

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![MH-S512-IL product image](https://opensmarthouse.org/assets/zwave/attachments/691/MH-S512.png)
