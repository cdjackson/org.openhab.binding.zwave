...
This describes the Z-Wave device *NZW36*, manufactured by *Willis Electric Co., Ltd.* with the thing type UID of ```Willis Electric Co., Ltd._nzw36_01_000```.
This version of the device is limited to firmware versions above 1.0

The device is in the category of *Power Outlet*, defining Small devices to be plugged into a power socket in a wall which stick there.

![NZW36 product image](https://opensmarthouse.org/assets/zwave/attachments/739/NZW36.png)
