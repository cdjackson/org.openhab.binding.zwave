...
This describes the Z-Wave device *DMMZ1*, manufactured by *Elexa Consumer Products Inc.* with the thing type UID of ```Elexa Consumer Products Inc._dmmz1_00_000```.

The device is in the category of *Lock*, defining Devices whose primary pupose is locking something.

![DMMZ1 product image](https://opensmarthouse.org/assets/zwave/attachments/684/dmmz1.png)
