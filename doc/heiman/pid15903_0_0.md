...
This describes the Z-Wave device *PID15903*, manufactured by *[Vision Security](http://www.visionsecurity.com.tw/)* with the thing type UID of ```Vision Security_pid15903_00_000```.

The device is in the category of *Power Outlet*, defining Small devices to be plugged into a power socket in a wall which stick there.

![PID15903 product image](https://opensmarthouse.org/assets/zwave/attachments/552/159031.jpg)
