...
This describes the Z-Wave device *Spirit*, manufactured by *Eurotronics* with the thing type UID of ```Eurotronics_spirit_00_000```.

The device is in the category of *Radiator Control*, defining Controls on radiators used to heat up rooms.

![Spirit product image](https://opensmarthouse.org/assets/zwave/attachments/710/spirit.jpg)
...
|--------------|------------|--------------|----------|-----------|
| Basic  [Deprecated]| basic_number | basic_number |  |  | 
| Dimmer | switch_dimmer | switch_dimmer |  |  | 
| Current temperature | sensor_temperature | sensor_temperature |  |  | 
| External temperature | sensor_report | sensor_report |  |  | 
| Thermostat mode | thermostat_mode | thermostat_mode |  |  | 
| Setpoint (heat) | thermostat_setpoint | thermostat_setpoint |  |  | 
| Setpoint (energy heat) | thermostat_setpoint | thermostat_setpoint |  |  | 
