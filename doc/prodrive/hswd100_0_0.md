...
This describes the Z-Wave device *HS-WD100+*, manufactured by *[HomeSeer Technologies](http://www.homeseer.com/)* with the thing type UID of ```HomeSeer Technologies_hswd100_00_000```.

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![HS-WD100+ product image](https://opensmarthouse.org/assets/zwave/attachments/346/hs-wd100-.jpg)
