...
# FT111 Nano Dimmer
This describes the Z-Wave device *FT111*, manufactured by *[Fantem](http://www.oomi.com/)* with the thing type UID of ```Fantem_ft111_00_000```.

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![FT111 product image](https://opensmarthouse.org/assets/zwave/attachments/851/ft111.jpg)
