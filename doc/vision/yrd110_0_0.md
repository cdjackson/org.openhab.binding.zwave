...
This describes the Z-Wave device *YRD110*, manufactured by *ASSA ABLOY* with the thing type UID of ```ASSA ABLOY_yrd110_00_000```.

The device is in the category of *Lock*, defining Devices whose primary pupose is locking something.

![YRD110 product image](https://opensmarthouse.org/assets/zwave/attachments/302/YRD110.jpg)
