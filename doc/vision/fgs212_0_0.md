...
This describes the Z-Wave device *FGS212*, manufactured by *[Fibargroup](http://www.fibaro.com/)* with the thing type UID of ```Fibargroup_fgs212_00_000```.

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![FGS212 product image](https://opensmarthouse.org/assets/zwave/attachments/114/fibaro-image.jpg)
