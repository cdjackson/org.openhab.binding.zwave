...
This describes the Z-Wave device *ZW132*, manufactured by *[AEON Labs](http://aeotec.com/)* with the thing type UID of ```AEON Labs_zw132_02_000```.
This version of the device is limited to firmware versions above 2.0

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![ZW132 product image](https://opensmarthouse.org/assets/zwave/attachments/1017/aeotec-nano-switch-3.jpg)
...
| Reset Meter  [Deprecated]| meter_reset1 | meter_reset |  |  | 
...
| Reset Meter  [Deprecated]| meter_reset2 | meter_reset |  |  | 
