...
This describes the Z-Wave device *MH9-CO2-WD*, manufactured by *[McoHome Technology Co., Ltd](http://www.mcohome.com/)* with the thing type UID of ```McoHome Technology Co., Ltd_mh9co2wd_00_000```.

The device is in the category of *Sensor*, defining Device used to measure something.

![MH9-CO2-WD product image](https://opensmarthouse.org/assets/zwave/attachments/455/CO2-Monitor-MH9-CO2-WD.png)
