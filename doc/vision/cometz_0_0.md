...
|--------------|------------|--------------|----------|-----------|
| Openness Of The Valve | switch_dimmer | switch_dimmer |  |  | 
| Temperature measured by the device | sensor_temperature | sensor_temperature |  |  | 
| Thermostat mode | thermostat_mode | thermostat_mode |  |  | 
| Temperature for Heat (Eco) | thermostat_setpoint | thermostat_setpoint |  |  | 
| Temperature for Heat (Comfort) | thermostat_setpoint | thermostat_setpoint |  |  | 
