...
This describes the Z-Wave device *PST02C*, manufactured by *[Philio Technology Corp](http://www.philio-tech.com/)* with the thing type UID of ```Philio Technology Corp_pst02c_00_000```.

The device is in the category of *Door*, defining Door sensors.

![PST02C product image](https://opensmarthouse.org/assets/zwave/attachments/170/z-wave-phili--multisensor-door-pir-light-temp-gen5.jpg)
...
|--------------|------------|--------------|----------|-----------|
| Binary Sensor (door) | sensor_binary | sensor_binary |  |  | 
