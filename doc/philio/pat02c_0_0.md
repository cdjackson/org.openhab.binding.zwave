...
This describes the Z-Wave device *PAT02-C*, manufactured by *[Philio Technology Corp](http://www.philio-tech.com/)* with the thing type UID of ```Philio Technology Corp_pat02c_00_000```.

The device is in the category of *Sensor*, defining Device used to measure something.

![PAT02-C product image](https://opensmarthouse.org/assets/zwave/attachments/178/PAN02c.jpg)
