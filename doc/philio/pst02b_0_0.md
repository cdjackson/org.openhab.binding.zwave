...
This describes the Z-Wave device *PST02B*, manufactured by *[Philio Technology Corp](http://www.philio-tech.com/)* with the thing type UID of ```Philio Technology Corp_pst02b_00_000```.

The device is in the category of *Sensor*, defining Device used to measure something.

![PST02B product image](https://opensmarthouse.org/assets/zwave/attachments/169/PST02B.jpg)
...
| Tamper Alarm  [Deprecated]| alarm_tamper | alarm_tamper |  |  | 
