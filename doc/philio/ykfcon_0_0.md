...
This describes the Z-Wave device *YKFCON*, manufactured by *ASSA ABLOY* with the thing type UID of ```ASSA ABLOY_ykfcon_00_000```.

The device is in the category of *Lock*, defining Devices whose primary pupose is locking something.

![YKFCON product image](https://opensmarthouse.org/assets/zwave/attachments/292/ykfcon-nomod-ch-ysp-3-1.jpg)
