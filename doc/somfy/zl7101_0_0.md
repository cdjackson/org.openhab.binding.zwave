...
This describes the Z-Wave device *ZL7101*, manufactured by *[Vision Security](http://www.visionsecurity.com.tw/)* with the thing type UID of ```Vision Security_zl7101_00_000```.

The device is in the category of *Power Outlet*, defining Small devices to be plugged into a power socket in a wall which stick there.

![ZL7101 product image](https://opensmarthouse.org/assets/zwave/attachments/371/zl7101.png)
