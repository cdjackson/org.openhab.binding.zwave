...
This describes the Z-Wave device *HTP-4S1-FB*, manufactured by *[Hogar Controls](http://hogarcontrols.com/)* with the thing type UID of ```Hogar Controls_htp4s1fb_02_002```.
This version of the device is limited to firmware versions above 2.2

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![HTP-4S1-FB product image](https://opensmarthouse.org/assets/zwave/attachments/545/9R8B1986.jpg)
