...
This describes the Z-Wave device *In-Wall Smart Motion Dimmer*, manufactured by *Jasco Products* with the thing type UID of ```Jasco Products_26933_00_000```.

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![In-Wall Smart Motion Dimmer product image](https://opensmarthouse.org/assets/zwave/attachments/740/26931-plus.png)
...
| Switch 1 | switch_dimmer1 | switch_dimmer |  |  | 
