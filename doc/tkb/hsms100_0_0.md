...
This describes the Z-Wave device *HS-MS100+*, manufactured by *[HomeSeer Technologies](http://www.homeseer.com/)* with the thing type UID of ```HomeSeer Technologies_hsms100_00_000```.

The device is in the category of *Motion Detector*, defining Motion sensors/detectors.

![HS-MS100+ product image](https://opensmarthouse.org/assets/zwave/attachments/802/HS-MS100-500L-large.jpg)
