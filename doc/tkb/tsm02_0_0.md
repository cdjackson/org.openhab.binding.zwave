...
This describes the Z-Wave device *TSM02*, manufactured by *TKB Home* with the thing type UID of ```TKB Home_tsm02_00_000```.

The device is in the category of *Sensor*, defining Device used to measure something.

![TSM02 product image](https://opensmarthouse.org/assets/zwave/attachments/162/-TSM02.png)
