...
This describes the Z-Wave device *TZ88*, manufactured by *TKB Home* with the thing type UID of ```TKB Home_tz88_00_000```.

The device is in the category of *Power Outlet*, defining Small devices to be plugged into a power socket in a wall which stick there.

![TZ88 product image](https://opensmarthouse.org/assets/zwave/attachments/161/tz88-uk.jpg)
