...
![ZD2102-5 product image](https://opensmarthouse.org/assets/zwave/attachments/713/zipato-security-door-window-sensor-z-wave-zd2102-5.jpg)
...
|--------------|------------|--------------|----------|-----------|
| Sensor (Alarm) | sensor_door | sensor_door |  |  | 
