...
This describes the Z-Wave device *TZ66D*, manufactured by *TKB Home* with the thing type UID of ```TKB Home_tz66d_00_000```.

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![TZ66D product image](https://opensmarthouse.org/assets/zwave/attachments/157/TZ66D.png)
