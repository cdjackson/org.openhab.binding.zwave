...
This describes the Z-Wave device *SES 303*, manufactured by *Horstmann Controls Limited* with the thing type UID of ```Horstmann Controls Limited_ses303_00_000```.

The device is in the category of *Sensor*, defining Device used to measure something.

![SES 303 product image](https://opensmarthouse.org/assets/zwave/attachments/782/ses303.jpg)
