...
This describes the Z-Wave device *ZWN-BPC-PLUS*, manufactured by *Wenzhou MTLC Electric Appliances Co.,Ltd.* with the thing type UID of ```Wenzhou MTLC Electric Appliances Co.,Ltd._zwnbpc_05_010```.
This version of the device is limited to firmware versions above 5.10

The device is in the category of *Motion Detector*, defining Motion sensors/detectors.

![ZWN-BPC-PLUS product image](https://opensmarthouse.org/assets/zwave/attachments/795/ZWN-BPC.JPG)
