...
This describes the Z-Wave device *TZ78*, manufactured by *TKB Home* with the thing type UID of ```TKB Home_tz78_00_000```.

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![TZ78 product image](https://opensmarthouse.org/assets/zwave/attachments/160/tz78-image.jpeg)
