...
This describes the Z-Wave device *CWS-3101*, manufactured by *[ID-RF](http://www.nodon.fr/)* with the thing type UID of ```ID-RF_cws3101_00_000```.

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![CWS-3101 product image](https://opensmarthouse.org/assets/zwave/attachments/294/CWS-3101.jpg)
