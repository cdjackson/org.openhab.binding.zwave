...
This describes the Z-Wave device *26931/ZW4006*, manufactured by *Jasco Products* with the thing type UID of ```Jasco Products_zw4006_00_000```.

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![26931/ZW4006 product image](https://opensmarthouse.org/assets/zwave/attachments/658/26931-plus.png)
...
| Motion Sensor Enable | config_decimal | config_decimal |  |  | 
| Operation Mode | config_decimal | config_decimal |  |  | 
| Motion Alarm  [Deprecated]| alarm_motion | alarm_motion |  |  | 
| Switch 1 | switch_binary1 | switch_binary |  |  | 
| Motion Alarm | alarm_motion2 | alarm_motion |  |  | 
