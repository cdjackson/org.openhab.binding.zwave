...
This describes the Z-Wave device *ZMNHKD*, manufactured by *[Goap](http://www.qubino.com/)* with the thing type UID of ```Goap_zmnhkd_00_000```.

The device is in the category of *HVAC*, defining Air condition devices, Fans.

![ZMNHKD product image](https://opensmarthouse.org/assets/zwave/attachments/829/zmnhkd.JPG)
