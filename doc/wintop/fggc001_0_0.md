...
This describes the Z-Wave device *FGGC001*, manufactured by *[Fibargroup](http://www.fibaro.com/)* with the thing type UID of ```Fibargroup_fggc001_00_000```.

The device is in the category of *Remote Control*, defining Any portable or hand-held device that controls the status of something, e.g. remote control, keyfob etc..

![FGGC001 product image](https://opensmarthouse.org/assets/zwave/attachments/349/swipe.jpg)
