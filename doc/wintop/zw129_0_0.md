...
# ZW129 Dual Wallmote
This describes the Z-Wave device *ZW129*, manufactured by *[AEON Labs](http://aeotec.com/)* with the thing type UID of ```AEON Labs_zw129_00_000```.

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![ZW129 product image](https://opensmarthouse.org/assets/zwave/attachments/390/s-l1000.jpg)
...
| Swipe Switch 1  [Deprecated]| switch_startstop1 | switch_startstop |  |  | 
| Scene Number 1  [Deprecated]| scene_number1 | scene_number |  |  | 
| Swipe Switch 2  [Deprecated]| switch_startstop2 | switch_startstop |  |  | 
| Scene Number 2  [Deprecated]| scene_number2 | scene_number |  |  | 
