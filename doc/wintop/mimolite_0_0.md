...
This describes the Z-Wave device *MIMOlite*, manufactured by *FortrezZ LLC* with the thing type UID of ```FortrezZ LLC_mimolite_00_000```.

The device is in the category of *Sensor*, defining Device used to measure something.

![MIMOlite product image](https://opensmarthouse.org/assets/zwave/attachments/219/mimolite.jpg)
