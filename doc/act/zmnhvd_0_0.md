...
This describes the Z-Wave device *ZMNHVD*, manufactured by *[Goap](http://www.qubino.com/)* with the thing type UID of ```Goap_zmnhvd_00_000```.

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![ZMNHVD product image](https://opensmarthouse.org/assets/zwave/attachments/363/z-wave-qubino-flush-dimmer-0-10v-plus.jpg)
...
| Input I1 | sensor_general | sensor_general |  |  | 
