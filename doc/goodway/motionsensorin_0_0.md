...
This describes the Z-Wave device *Motion Sensor IN*, manufactured by *[Shenzhen Neo Electronics Co., Ltd](http://www.szneo.com/)* with the thing type UID of ```Shenzhen Neo Electronics Co., Ltd_motionsensorin_00_000```.

The device is in the category of *Sensor*, defining Device used to measure something.

![Motion Sensor IN product image](https://opensmarthouse.org/assets/zwave/attachments/478/NEO-Motion.jpg)
