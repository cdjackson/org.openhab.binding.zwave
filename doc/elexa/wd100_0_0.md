...
This describes the Z-Wave device *WD-100*, manufactured by *Z Wave Products Inc.* with the thing type UID of ```Z Wave Products Inc._wd100_00_000```.

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![WD-100 product image](https://opensmarthouse.org/assets/zwave/attachments/590/WD100.jpg)
