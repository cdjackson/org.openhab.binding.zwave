...
This describes the Z-Wave device *FE599NX*, manufactured by *Allegion* with the thing type UID of ```Allegion_fe599nx_00_000```.

The device is in the category of *Lock*, defining Devices whose primary pupose is locking something.

![FE599NX product image](https://opensmarthouse.org/assets/zwave/attachments/403/FE599NX.jpg)
