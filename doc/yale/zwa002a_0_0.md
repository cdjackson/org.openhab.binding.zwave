...
This describes the Z-Wave device *ZWA002*, manufactured by *Aeotec Limited* with the thing type UID of ```Aeotec Limited_zwa002a_00_000```.

The device is in the category of *Light Bulb*, defining Devices that illuminate something, such as bulbs, etc..

![ZWA002 product image](https://opensmarthouse.org/assets/zwave/attachments/949/z-wave-led-bulb-6-multi-colour-2x.png)
