...
This describes the Z-Wave device *BE468*, manufactured by *Allegion* with the thing type UID of ```Allegion_be468_00_000```.

The device is in the category of *Lock*, defining Devices whose primary pupose is locking something.

![BE468 product image](https://opensmarthouse.org/assets/zwave/attachments/240/BE468.png)
