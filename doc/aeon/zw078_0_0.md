...
This describes the Z-Wave device *ZW078*, manufactured by *[AEON Labs](http://aeotec.com/)* with the thing type UID of ```AEON Labs_zw078_00_000```.

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![ZW078 product image](https://opensmarthouse.org/assets/zwave/attachments/65/aeotec-zw078.jpg)
...
| Sensor (internal temperature) | sensor_temperature | sensor_temperature |  |  | 
