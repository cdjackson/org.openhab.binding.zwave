...
This describes the Z-Wave device *MH-S521*, manufactured by *[McoHome Technology Co., Ltd](http://www.mcohome.com/)* with the thing type UID of ```McoHome Technology Co., Ltd_mhs521_00_000```.

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![MH-S521 product image](https://opensmarthouse.org/assets/zwave/attachments/722/mh-s521.PNG)
