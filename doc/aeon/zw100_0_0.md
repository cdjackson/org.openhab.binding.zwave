...
# ZW100 MultiSensor 6
This describes the Z-Wave device *ZW100*, manufactured by *[AEON Labs](http://aeotec.com/)* with the thing type UID of ```AEON Labs_zw100_00_000```.
This version of the device is limited to firmware versions below 1.6

The device is in the category of *Sensor*, defining Device used to measure something.

![ZW100 product image](https://opensmarthouse.org/assets/zwave/attachments/73/zw100-front.png)
...
|--------------|------------|--------------|----------|-----------|
| Sensor (motion) | sensor_binary | sensor_binary |  |  | 
| Sensor (relative humidity) | sensor_relhumidity | sensor_relhumidity |  |  | 
| Sensor (ultraviolet) | sensor_ultraviolet | sensor_ultraviolet |  |  | 
