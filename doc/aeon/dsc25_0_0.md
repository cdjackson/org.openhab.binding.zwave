...
This describes the Z-Wave device *DSC25*, manufactured by *[AEON Labs](http://aeotec.com/)* with the thing type UID of ```AEON Labs_dsc25_00_000```.

The device is in the category of *Power Outlet*, defining Small devices to be plugged into a power socket in a wall which stick there.

![DSC25 product image](https://opensmarthouse.org/assets/zwave/attachments/276/DSC25.png)
