...
This describes the Z-Wave device *Z-Weather*, manufactured by *Z-Wave.Me* with the thing type UID of ```Z-Wave.Me_zweather_00_000```.
...
| Sensor (barometric pressure) | sensor_barpressure | sensor_barpressure |  |  | 
