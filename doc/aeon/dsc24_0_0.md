...
This describes the Z-Wave device *DSC24*, manufactured by *[AEON Labs](http://aeotec.com/)* with the thing type UID of ```AEON Labs_dsc24_00_000```.

The device is in the category of *Power Outlet*, defining Small devices to be plugged into a power socket in a wall which stick there.

![DSC24 product image](https://opensmarthouse.org/assets/zwave/attachments/76/DSC24.jpg)
