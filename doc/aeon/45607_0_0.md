...
This describes the Z-Wave device *45607*, manufactured by *Jasco Products* with the thing type UID of ```Jasco Products_45607_00_000```.

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![45607 product image](https://opensmarthouse.org/assets/zwave/attachments/377/45607.png)
