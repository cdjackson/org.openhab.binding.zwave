...
This describes the Z-Wave device *DSC26*, manufactured by *[AEON Labs](http://aeotec.com/)* with the thing type UID of ```AEON Labs_dsc26_00_000```.

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![DSC26 product image](https://opensmarthouse.org/assets/zwave/attachments/82/61K9Gjkr4-L--SL1000-.jpg)
