...
This describes the Z-Wave device *ZW099*, manufactured by *[AEON Labs](http://aeotec.com/)* with the thing type UID of ```AEON Labs_zw099_00_000```.

The device is in the category of *Power Outlet*, defining Small devices to be plugged into a power socket in a wall which stick there.

![ZW099 product image](https://opensmarthouse.org/assets/zwave/attachments/275/ZW099-all.png)
...
| Power Consumption (kWh) | meter_kwh | meter_kwh |  |  | 
| Energy Consumption (watts) | meter_watts | meter_watts |  |  | 
| Night mode color | color_color | color_color |  |  | 
