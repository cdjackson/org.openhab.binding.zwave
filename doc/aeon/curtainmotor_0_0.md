...
This describes the Z-Wave device *JTB-1007*, manufactured by *UFairy G.R. Tech* with the thing type UID of ```UFairy G.R. Tech_curtainmotor_00_000```.

The device is in the category of *Blinds*, defining Roller shutters, window blinds, etc..

![JTB-1007 product image](https://opensmarthouse.org/assets/zwave/attachments/1247/curtain-motor.jpg)
