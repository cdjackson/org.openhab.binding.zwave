...
This describes the Z-Wave device *DSC35*, manufactured by *[AEON Labs](http://aeotec.com/)* with the thing type UID of ```AEON Labs_dsc35_00_000```.

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![DSC35 product image](https://opensmarthouse.org/assets/zwave/attachments/528/DSC35.png)
