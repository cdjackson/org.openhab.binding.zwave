...
This describes the Z-Wave device *DSC14*, manufactured by *[AEON Labs](http://aeotec.com/)* with the thing type UID of ```AEON Labs_dsc14_00_000```.

The device is in the category of *Blinds*, defining Roller shutters, window blinds, etc..

![DSC14 product image](https://opensmarthouse.org/assets/zwave/attachments/289/DSC14.png)
