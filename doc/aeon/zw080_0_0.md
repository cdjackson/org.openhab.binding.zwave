...
# ZW080 Siren Gen5
This describes the Z-Wave device *ZW080*, manufactured by *[AEON Labs](http://aeotec.com/)* with the thing type UID of ```AEON Labs_zw080_00_000```.

The device is in the category of *Siren*, defining Siren used by Alarm systems.

![ZW080 product image](https://opensmarthouse.org/assets/zwave/attachments/90/zw080.jpg)
...
| Sound and Volume | config_decimal | config_decimal |  |  | 
