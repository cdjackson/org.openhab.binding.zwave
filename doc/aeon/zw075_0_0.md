...
This describes the Z-Wave device *ZW075*, manufactured by *[AEON Labs](http://aeotec.com/)* with the thing type UID of ```AEON Labs_zw075_00_000```.
This version of the device is limited to firmware versions below 3.255

The device is in the category of *Power Outlet*, defining Small devices to be plugged into a power socket in a wall which stick there.

![ZW075 product image](https://opensmarthouse.org/assets/zwave/attachments/83/zw075-uk.jpg)
