...
This describes the Z-Wave device *BTZW125*, manufactured by *[Poly-control](https://www.danalock.com/)* with the thing type UID of ```Poly-control_btzu125_00_000```.

The device is in the category of *Lock*, defining Devices whose primary pupose is locking something.

![BTZW125 product image](https://opensmarthouse.org/assets/zwave/attachments/407/danalock-box.jpg)
