...
This describes the Z-Wave device *ZIPATO ZIP-PSG01*, manufactured by *[Philio Technology Corp](http://www.philio-tech.com/)* with the thing type UID of ```Philio Technology Corp_psg01_00_000```.

The device is in the category of *Smoke Detector*, defining Smoke detectors.

![ZIPATO ZIP-PSG01 product image](https://opensmarthouse.org/assets/zwave/attachments/1097/PSG01.png)
