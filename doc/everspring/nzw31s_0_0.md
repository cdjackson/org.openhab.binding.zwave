...
This describes the Z-Wave device *NZW31S*, manufactured by *NIE Technology* with the thing type UID of ```NIE Technology_nzw31s_00_000```.

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![NZW31S product image](https://opensmarthouse.org/assets/zwave/attachments/856/NZW31.jpg)
