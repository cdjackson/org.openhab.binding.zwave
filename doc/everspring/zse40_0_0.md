...
This describes the Z-Wave device *ZSE40*, manufactured by *[Vision Security](http://www.visionsecurity.com.tw/)* with the thing type UID of ```Vision Security_zse40_00_000```.

The device is in the category of *Motion Detector*, defining Motion sensors/detectors.

![ZSE40 product image](https://opensmarthouse.org/assets/zwave/attachments/307/zooz-multisensor.jpg)
