...
This describes the Z-Wave device *RF9537*, manufactured by *Cooper Wiring Devices* with the thing type UID of ```Cooper Wiring Devices_rf9537_00_000```.
This version of the device is limited to firmware versions below 3.4

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![RF9537 product image](https://opensmarthouse.org/assets/zwave/attachments/905/RF9537-NDW-C--500x500-72dpi-.jpg)
