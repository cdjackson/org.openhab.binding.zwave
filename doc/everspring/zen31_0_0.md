...
| Preset Program | config_decimal | config_decimal |  |  | 
| Dimmer (brightness) | switch_dimmer1 | switch_dimmer |  |  | 
| Electric meter (watts) 1 | meter_watts1 | meter_watts |  |  | 
| Electric meter (kWh) 1 | meter_kwh1 | meter_kwh |  |  | 
| Color Control | color_color1 | color_color |  |  | 
| Color Temperature | color_temperature1 | color_temperature |  |  | 
| Alarm (system) 1 | alarm_system1 | alarm_system |  |  | 
| Alarm (power) 1 | alarm_power1 | alarm_power |  |  | 
| Dimmer (red) | switch_dimmer2 | switch_dimmer |  |  | 
| Dimmer (green) | switch_dimmer3 | switch_dimmer |  |  | 
| Dimmer (blue) | switch_dimmer4 | switch_dimmer |  |  | 
| Dimmer (white) | switch_dimmer5 | switch_dimmer |  |  | 
