...
# ZMNHJA Flush Pilot
This describes the Z-Wave device *ZMNHJA*, manufactured by *[Goap](http://www.qubino.com/)* with the thing type UID of ```Goap_zmnhja_00_000```.

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![ZMNHJA product image](https://opensmarthouse.org/assets/zwave/attachments/354/ZMNHJA.png)
