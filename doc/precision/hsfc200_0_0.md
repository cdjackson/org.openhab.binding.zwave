...
This describes the Z-Wave device *HS-FC200+*, manufactured by *[HomeSeer Technologies](http://www.homeseer.com/)* with the thing type UID of ```HomeSeer Technologies_hsfc200_00_000```.

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![HS-FC200+ product image](https://opensmarthouse.org/assets/zwave/attachments/957/HS-FC200-Trimplate-500-2-81502f27-b635-4b8b-a0b1-e8ea0478d54d-1024x1024.jpg)
...
| Mode of Operation | config_decimal | config_decimal |  |  | 
| Normal mode LED color | config_decimal | config_decimal |  |  | 
| Status mode LED 1 color | config_decimal | config_decimal |  |  | 
| Status mode LED 2 color | config_decimal | config_decimal |  |  | 
| Status mode LED 3 color | config_decimal | config_decimal |  |  | 
| Status mode LED 4 color | config_decimal | config_decimal |  |  | 
| Status mode LEDs Blink frequency | config_decimal | config_decimal |  |  | 
| Status mode LEDs Blink status (Bitmask) | config_decimal | config_decimal |  |  | 
