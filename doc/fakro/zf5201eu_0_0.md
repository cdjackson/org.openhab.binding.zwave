...
This describes the Z-Wave device *ZF5201EU-5*, manufactured by *[Vision Security](http://www.visionsecurity.com.tw/)* with the thing type UID of ```Vision Security_zf5201eu_00_000```.

The device is in the category of *Sensor*, defining Device used to measure something.

![ZF5201EU-5 product image](https://opensmarthouse.org/assets/zwave/attachments/849/Flood-Sensor.png)
