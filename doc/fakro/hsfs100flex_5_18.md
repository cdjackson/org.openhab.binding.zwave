...
This describes the Z-Wave device *HS-FS100+ Flex*, manufactured by *[HomeSeer Technologies](http://www.homeseer.com/)* with the thing type UID of ```HomeSeer Technologies_hsfs100flex_05_018```.
This version of the device is limited to firmware versions above 5.18

The device is in the category of *Sensor*, defining Device used to measure something.

![HS-FS100+ Flex product image](https://opensmarthouse.org/assets/zwave/attachments/1069/fs100flex.jpg)
