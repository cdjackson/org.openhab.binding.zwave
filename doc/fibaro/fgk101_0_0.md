...
This describes the Z-Wave device *FGK101*, manufactured by *[Fibargroup](http://www.fibaro.com/)* with the thing type UID of ```Fibargroup_fgk101_00_000```.
This version of the device is limited to firmware versions below 2.3

The device is in the category of *Door*, defining Door sensors.

![FGK101 product image](https://opensmarthouse.org/assets/zwave/attachments/125/FGK-101.jpg)
...
| Temperature Sensor | sensor_temperature2 | sensor_temperature |  |  | 
