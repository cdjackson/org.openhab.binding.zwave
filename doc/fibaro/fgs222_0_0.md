...
This describes the Z-Wave device *FGS222*, manufactured by *[Fibargroup](http://www.fibaro.com/)* with the thing type UID of ```Fibargroup_fgs222_00_000```.

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![FGS222 product image](https://opensmarthouse.org/assets/zwave/attachments/124/FGS222.jpg)
