...
This describes the Z-Wave device *ZP3102*, manufactured by *[Vision Security](http://www.visionsecurity.com.tw/)* with the thing type UID of ```Vision Security_zp3102_08_000```.
This version of the device is limited to firmware versions above 8.0

The device is in the category of *Motion Detector*, defining Motion sensors/detectors.

![ZP3102 product image](https://opensmarthouse.org/assets/zwave/attachments/437/zp3102.jpg)
