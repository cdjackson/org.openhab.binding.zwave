...
This describes the Z-Wave device *NZW37*, manufactured by *Willis Electric Co., Ltd.* with the thing type UID of ```Willis Electric Co., Ltd._nzw37_00_000```.

The device is in the category of *Power Outlet*, defining Small devices to be plugged into a power socket in a wall which stick there.

![NZW37 product image](https://opensmarthouse.org/assets/zwave/attachments/788/NZW37-015D-2500-2500.png)
