...
This describes the Z-Wave device *FGFS101*, manufactured by *[Fibargroup](http://www.fibaro.com/)* with the thing type UID of ```Fibargroup_fgfs101_00_000```.
This version of the device is limited to firmware versions below 3.0

The device is in the category of *Sensor*, defining Device used to measure something.

![FGFS101 product image](https://opensmarthouse.org/assets/zwave/attachments/127/fgfs101.jpg)
...
| Alarm (water) | sensor_flood | sensor_flood |  |  | 
