...
| Sensor (power)  [Deprecated]| sensor_power | sensor_power |  |  | 
| Electric meter (kWh)  [Deprecated]| meter_kwh | meter_kwh |  |  | 
| Electric meter (watts)  [Deprecated]| meter_watts | meter_watts |  |  | 
| Reset the total power consumption | meter_reset | meter_reset |  |  | 
| Force initial brightness | config_decimal | config_decimal |  |  | 
| Alarm | alarm_general | alarm_general |  |  | 
| Alarm (Hardware Fail) | alarm_system | alarm_system |  |  | 
| Alarm (Power) | alarm_power | alarm_power |  |  | 
| Alarm (Heat) | alarm_heat | alarm_heat |  |  | 
| Dimmer Switch 1 | switch_dimmer1 | switch_dimmer |  |  | 
...
| Send notification | notification_send1 | notification_send |  |  | 
| Alarm (Hardware Fail) | alarm_system1 | alarm_system |  |  | 
| Alarm (Power) | alarm_power1 | alarm_power |  |  | 
| Alarm (Heat) | alarm_heat1 | alarm_heat |  |  | 
| Dimmer Switch 2 | switch_dimmer2 | switch_dimmer |  |  | 
