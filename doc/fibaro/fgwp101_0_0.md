...
| LED color when device is on | config_decimal | config_decimal |  |  | 
| LED color when device is off | config_decimal | config_decimal |  |  | 
| Start Alarm LED Illumination | notification_send | notification_send |  |  | 
