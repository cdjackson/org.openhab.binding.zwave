...
This describes the Z-Wave device *FGSD002*, manufactured by *[Fibargroup](http://www.fibaro.com/)* with the thing type UID of ```Fibargroup_fgsd002_00_000```.
This version of the device is limited to firmware versions below 3.1

The device is in the category of *Smoke Detector*, defining Smoke detectors.

![FGSD002 product image](https://opensmarthouse.org/assets/zwave/attachments/129/FGSD002.png)
