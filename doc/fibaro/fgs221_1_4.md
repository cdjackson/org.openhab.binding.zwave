...
This describes the Z-Wave device *FGS221*, manufactured by *[Fibargroup](http://www.fibaro.com/)* with the thing type UID of ```Fibargroup_fgs221_01_004```.
This version of the device is limited to firmware version 1.4

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![FGS221 product image](https://opensmarthouse.org/assets/zwave/attachments/121/fds221.jpg)
