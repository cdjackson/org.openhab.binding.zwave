...
This describes the Z-Wave device *FGD211*, manufactured by *[Fibargroup](http://www.fibaro.com/)* with the thing type UID of ```Fibargroup_fgd211_01_009```.
This version of the device is limited to firmware version 1.9

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![FGD211 product image](https://opensmarthouse.org/assets/zwave/attachments/118/fgd211.jpg)
...
| Updating the dimming level without switch | config_decimal | config_decimal |  |  | 
