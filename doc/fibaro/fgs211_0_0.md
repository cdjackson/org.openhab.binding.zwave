...
This describes the Z-Wave device *FGS211*, manufactured by *[Fibargroup](http://www.fibaro.com/)* with the thing type UID of ```Fibargroup_fgs211_00_000```.
This version of the device is limited to firmware versions below 2.0

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![FGS211 product image](https://opensmarthouse.org/assets/zwave/attachments/120/fgs211.jpeg)
