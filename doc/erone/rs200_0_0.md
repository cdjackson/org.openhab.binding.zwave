...
This describes the Z-Wave device *RS200*, manufactured by *Ingersoll Rand (was Ecolink)* with the thing type UID of ```Ingersoll Rand (was Ecolink)_rs200_00_000```.

The device is in the category of *Sensor*, defining Device used to measure something.

![RS200 product image](https://opensmarthouse.org/assets/zwave/attachments/695/Schlage-PIR.png)
