...
This describes the Z-Wave device *CT101*, manufactured by *Radio Thermostat Company of America (RTC)* with the thing type UID of ```Radio Thermostat Company of America (RTC)_ct101_00_000```.

The device is in the category of *HVAC*, defining Air condition devices, Fans.

![CT101 product image](https://opensmarthouse.org/assets/zwave/attachments/98/CT101.jpg)
