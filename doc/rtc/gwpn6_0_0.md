...
This describes the Z-Wave device *GWPN6*, manufactured by *GreenWave Reality Inc.* with the thing type UID of ```GreenWave Reality Inc._gwpn6_00_000```.

The device is in the category of *Power Outlet*, defining Small devices to be plugged into a power socket in a wall which stick there.

![GWPN6 product image](https://opensmarthouse.org/assets/zwave/attachments/100/GWPN6.jpg)
...
| Electric meter (watts) 6 | meter_watts6 | meter_watts |  |  | 
| Electric meter (kWh) 6 | meter_kwh6 | meter_kwh |  |  | 
