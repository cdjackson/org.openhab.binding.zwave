...
This describes the Z-Wave device *ZDB5100*, manufactured by *[Logic Group](http://www.logic-group.com)* with the thing type UID of ```Logic Group_zdb5100_00_000```.

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![ZDB5100 product image](https://opensmarthouse.org/assets/zwave/attachments/1091/matrix-graa-lys-300x300.jpg)
...
|  Colour commands for LED indication, pushbutton 1 | config_decimal | config_decimal |  |  | 
| Colour commands for LED indication, pushbutton 2 | config_decimal | config_decimal |  |  | 
| Colour commands for LED indication,  pushbutton 3 | config_decimal | config_decimal |  |  | 
| Colour commands for LED indication, pushbutton 4 | config_decimal | config_decimal |  |  | 
| Global brightness control | config_decimal | config_decimal |  |  | 
| State, pushbutton 1 | switch_binary1 | switch_binary |  |  | 
| Color, pushbutton 1 | color_color1 | color_color |  |  | 
| State,  pushbutton 2 | switch_binary2 | switch_binary |  |  | 
| Color,  pushbutton 2 | color_color2 | color_color |  |  | 
| State, pushbutton 3 | switch_binary3 | switch_binary |  |  | 
| Color, pushbutton 3 | color_color3 | color_color |  |  | 
| State, pushbutton 4 | switch_binary4 | switch_binary |  |  | 
| Color, pushbutton 4 | color_color4 | color_color |  |  | 
| Dimmer | switch_dimmer5 | switch_dimmer |  |  | 
