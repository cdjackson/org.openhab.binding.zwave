...
This describes the Z-Wave device *GWPN1*, manufactured by *GreenWave Reality Inc.* with the thing type UID of ```GreenWave Reality Inc._gwpn1_03_000```.
This version of the device is limited to firmware versions above 3.0

The device is in the category of *Power Outlet*, defining Small devices to be plugged into a power socket in a wall which stick there.

![GWPN1 product image](https://opensmarthouse.org/assets/zwave/attachments/102/ns210-gb.jpg)
...
| Reset total power consumption | meter_reset | meter_reset |  |  | 
