...
This describes the Z-Wave device *FGWPB-121*, manufactured by *[Fibargroup](http://www.fibaro.com/)* with the thing type UID of ```Fibargroup_fgwpb121_00_000```.

The device is in the category of *Power Outlet*, defining Small devices to be plugged into a power socket in a wall which stick there.

![FGWPB-121 product image](https://opensmarthouse.org/assets/zwave/attachments/808/FGWPB-121.jpg)
...
| Reset Meter | meter_reset1 | meter_reset |  |  | 
| Alarm (system) | alarm_system1 | alarm_system |  |  | 
| Alarm (power) | alarm_power1 | alarm_power |  |  | 
| Protection Local | protection_local1 | protection_local |  |  | 
| Electric meter (kWh) | meter_kwh2 | meter_kwh |  |  | 
| Electric meter (watts) | meter_watts2 | meter_watts |  |  | 
| Reset Meter | meter_reset2 | meter_reset |  |  | 
