...
This describes the Z-Wave device *SM103*, manufactured by *[Chromagic Technologies Corporation](http://www.ctc-chromagic.com/)* with the thing type UID of ```Chromagic Technologies Corporation_sm103_00_000```.

The device is in the category of *Sensor*, defining Device used to measure something.

![SM103 product image](https://opensmarthouse.org/assets/zwave/attachments/428/sm103.png)
