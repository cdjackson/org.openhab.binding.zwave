...
This describes the Z-Wave device *ZMNHXD*, manufactured by *[Goap](http://www.qubino.com/)* with the thing type UID of ```Goap_zmnhxd_00_000```.

The device is in the category of *Sensor*, defining Device used to measure something.

![ZMNHXD product image](https://opensmarthouse.org/assets/zwave/attachments/900/Screenshot-2018-09-20-3-Phase-Smart-Meter---Qubino-1-.png)
...
| Electric meter (kVAh) 1 | meter_kvah1 | meter_kvah |  |  | 
...
| Electric meter (power factor) 4 | meter_powerfactor4 | meter_powerfactor |  |  | 
| Electric meter (amps) 4 | meter_current4 | meter_current |  |  | 
