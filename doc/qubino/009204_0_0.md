...
This describes the Z-Wave device *009204*, manufactured by *Popp & Co* with the thing type UID of ```Popp & Co_009204_00_000```.

The device is in the category of *Remote Control*, defining Any portable or hand-held device that controls the status of something, e.g. remote control, keyfob etc..

![009204 product image](https://opensmarthouse.org/assets/zwave/attachments/415/009204.png)
