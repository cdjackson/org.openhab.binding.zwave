...
This describes the Z-Wave device *Jasco 14318*, manufactured by *Jasco Products* with the thing type UID of ```Jasco Products_14318_00_000```.

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![Jasco 14318 product image](https://opensmarthouse.org/assets/zwave/attachments/717/14318.png)
