...
This describes the Z-Wave device *ZW112*, manufactured by *[AEON Labs](http://aeotec.com/)* with the thing type UID of ```AEON Labs_zw112_00_000```.

The device is in the category of *Door*, defining Door sensors.

![ZW112 product image](https://opensmarthouse.org/assets/zwave/attachments/274/AEOEZW112.jpg)
