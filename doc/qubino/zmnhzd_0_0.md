...
This describes the Z-Wave device *ZMNHZD*, manufactured by *[Goap](http://www.qubino.com/)* with the thing type UID of ```Goap_zmnhzd_00_000```.

The device is in the category of *Sensor*, defining Device used to measure something.

![ZMNHZD product image](https://opensmarthouse.org/assets/zwave/attachments/364/ZMNHZD.jpg)
...
|--------------|------------|--------------|----------|-----------|
| Sensor (velocity) | sensor_velocity | sensor_velocity |  |  | 
| Sensor (temperature) | sensor_temperature | sensor_temperature |  |  | 
| Sensor (relative humidity) | sensor_relhumidity | sensor_relhumidity |  |  | 
| Sensor (direction) | sensor_direction | sensor_direction |  |  | 
| Sensor (rain rate) | sensor_rainrate | sensor_rainrate |  |  | 
| Battery Level | battery-level | system.battery_level | Battery | Number |
| Thermo/ Hygro Sensor Ch1 – Temperature | sensor_temperature1 | sensor_temperature |  |  | 
| Battery Level | battery-level | system.battery_level | Battery | Number |
| Wind Gauge – Direction | sensor_direction2 | sensor_direction |  |  | 
| Battery Level | battery-level | system.battery_level | Battery | Number |
| Wind Gauge – Velocity | sensor_velocity3 | sensor_velocity |  |  | 
| Battery Level | battery-level | system.battery_level | Battery | Number |
| Wind Gauge – Wind gust | sensor_velocity4 | sensor_velocity |  |  | 
| Battery Level | battery-level | system.battery_level | Battery | Number |
|  Wind Gauge – Temperature | sensor_temperature5 | sensor_temperature |  |  | 
| Battery Level | battery-level | system.battery_level | Battery | Number |
| Wind Gauge – Wind Chill | sensor_temperature6 | sensor_temperature |  |  | 
| Battery Level | battery-level | system.battery_level | Battery | Number |
|  Rain Sensor | sensor_rainrate7 | sensor_rainrate |  |  | 
| Battery Level | battery-level | system.battery_level | Battery | Number |
|  Thermo/ Hygro Sensor Ch1 – Humidity | sensor_relhumidity8 | sensor_relhumidity |  |  | 
| Battery Level | battery-level | system.battery_level | Battery | Number |
| Thermo/ Hygro Sensor Ch2 – Temperature | sensor_temperature9 | sensor_temperature |  |  | 
| Battery Level | battery-level | system.battery_level | Battery | Number |
|  Thermo/ Hygro Sensor Ch2 – Humidity  | sensor_relhumidity10 | sensor_relhumidity |  |  | 
| Battery Level | battery-level | system.battery_level | Battery | Number |
