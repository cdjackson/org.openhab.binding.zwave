...
This describes the Z-Wave device *NZW31*, manufactured by *NIE Technology* with the thing type UID of ```NIE Technology_dimmer_00_000```.

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![NZW31 product image](https://opensmarthouse.org/assets/zwave/attachments/807/91E7I5-H9bL--SL1500-.jpg)
