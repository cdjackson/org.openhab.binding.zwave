...
This describes the Z-Wave device *MH-S512*, manufactured by *[McoHome Technology Co., Ltd](http://www.mcohome.com/)* with the thing type UID of ```McoHome Technology Co., Ltd_mhs512_00_000```.
This version of the device is limited to firmware versions below 4.255

The device is in the category of *Wall Switch*, defining Any device attached to the wall that controls a binary status of something, for ex. a light switch.

![MH-S512 product image](https://opensmarthouse.org/assets/zwave/attachments/1066/MH-S512.png)
