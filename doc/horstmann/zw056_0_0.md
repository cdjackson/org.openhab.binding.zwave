...
# ZW056 Doorbell
This describes the Z-Wave device *ZW056*, manufactured by *[AEON Labs](http://aeotec.com/)* with the thing type UID of ```AEON Labs_zw056_00_000```.

The device is in the category of *Door*, defining Door sensors.

![ZW056 product image](https://opensmarthouse.org/assets/zwave/attachments/263/ZW056.jpeg)
...
| Volume | config_decimal | config_decimal |  |  | 
| Repititions | config_decimal | config_decimal |  |  | 
| Play Chime Now | config_decimal | config_decimal |  |  | 
| Doorbell Notifications | config_decimal | config_decimal |  |  | 
| Button Battery Status | config_decimal | config_decimal |  |  | 
